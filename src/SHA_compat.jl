import .SHA: transform!, SHA2_224_CTX, SHA2_256_CTX, SHA2_384_CTX, SHA2_512_CTX,
    Sigma0_256, Sigma0_512, Sigma1_256, Sigma1_512, sigma0_256, sigma0_512, sigma1_256, sigma1_512,
    Ch, K256, Maj, buffer_pointer

@unchecked function transform!(context::T) where {T<:Union{SHA2_224_CTX,SHA2_256_CTX}}
...
@unchecked function transform!(context::Union{SHA2_384_CTX,SHA2_512_CTX})
    pbuf = buffer_pointer(context)
